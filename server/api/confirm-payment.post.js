...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    // O `order.customerIdentifier` agora é o e-mail correto preenchido no formulário
    if (order.customerIdentifier) {
      try {
        ...
        // --- LÓGICA MODIFICADA ---
        // Usa o nome salvo no pedido; se não houver, usa um genérico.
        ...
        await sendEmail({
          to: order.customerIdentifier, // Este é o e-mail correto agora
