    ...
    <VWindow v-model="currentTab">
      <VWindowItem class="pa-4">
        ...
        <VSheet border rounded class="pa-4">
          ...
          <VTextField v-model="announcementBar.countdownText" variant="outlined" density="compact" maxlength="50"
            counter />
          ...
          <div class="d-flex align-center gap-x-2">
            ...
            <VTextField v-model.number="announcementBar.countdownMinutes" variant="outlined" density="compact"
              hide-details style="max-width: 80px;" class="text-center" type="number" min="0" />
          ...
          <div class="d-flex align-center gap-x-2">
            ...
            <VTextField v-model="announcementBar.barColor" variant="outlined" density="compact" hide-details />
          </div>
          ...
          <div class="d-flex align-center gap-x-2">
            ...
            <VTextField v-model="announcementBar.textColor" variant="outlined" density="compact" hide-details />
          </div>
          ...
          <div class="d-flex align-center gap-x-2">
            ...
            <VTextField v-model="announcementBar.countdownColor" variant="outlined" density="compact" hide-details />
          </div>
        </VSheet>
      </VWindowItem>
      ...
      <VWindowItem class="pa-4">
        ...
        <VSheet border rounded class="pa-4">
          ...
          <div class="d-flex align-center gap-x-2">
            ...
            <VTextField v-model="footer.backgroundColor" variant="outlined" density="compact" hide-details />
          </div>
          <VLabel class="mt-4 mb-1">Cor do texto</VLabel>
          <div class="d-flex align-center gap-x-2">
            <VMenu activator="parent" :close-on-content-click="false">
        ...
        <VSheet border rounded class="pa-4">
          ...
          <div v-if="footer.showSupport" class="mt-4">
            <VCheckbox v-model="footer.showWhatsapp" label="Mostrar WhatsApp" color="success" />
      ...
      <VWindowItem class="pa-4">
        ...
        <p class="text-h6 mt-6 mb-4">Configurações</p>
        <VSheet border rounded class="pa-4">
          <VCheckbox v-model="showCouponField" label="Exibir campo de cupom de desconto" color="success" />
        </VSheet>
      </VWindowItem>
      ...
      <VWindowItem class="pa-4">
        ...
        <VSheet border rounded class="pa-4">
          ...
          <div class="d-flex align-center gap-x-2 mb-4">
            ...
            <VTextField v-model="themeColors.primaryButtonBg" variant="outlined" density="compact" hide-details />
          </div>
          ...
          <div class="d-flex align-center gap-x-2">
            ...
            <VTextField v-model="themeColors.primaryButtonText" variant="outlined" density="compact" hide-details />
          </div>
          <VDivider class="my-4" />
          ...
          <div class="d-flex align-center gap-x-2 mb-4">
            ...
            <VTextField v-model="themeColors.navigationButtonBg" variant="outlined" density="compact" hide-details />
          </div>
          <VLabel class="mb-1">Cor do texto</VLabel>
          <div class="d-flex align-center gap-x-2">
            <VMenu activator="parent" :close-on-content-click="false">
            ...
            <VTextField v-model="themeColors.navigationButtonText" variant="outlined" density="compact" hide-details />
          </div>
        </VSheet>
        <div class="d-flex justify-space-between align-center mt-6 mb-4">
        ...
        <VSheet border rounded class="pa-4">
          ...
          <div class="d-flex align-center gap-x-2 mb-4">
            ...
            <VTextField v-model="themeColors.descriptions" variant="outlined" density="compact" hide-details />
          </div>
          ...
          <div class="d-flex align-center gap-x-2 mb-4">
            ...
            <VTextField v-model="themeColors.totalValue" variant="outlined" density="compact" hide-details />
          </div>
        </VSheet>
      </VWindowItem>
      ...
      <VWindowItem class="pa-4">
        ...
        <VSheet border rounded class="pa-4">
          <div class="d-flex justify-space-between align-center">
            ...
            <VBtn variant="text" size="small" @click="generatorStore.resetMiniChatColors()">Resetar cores</VBtn>
          </div>
          ...
          <div v-if="miniChat.enabled">
            <VLabel class="mt-4 mb-1">Título</VLabel>
            <VTextField v-model="miniChat.title" variant="outlined" density="compact" placeholder="Boas-vindas!" />
            <VLabel class="mt-4 mb-1">Cor do Ícone</VLabel>
            <div class="d-flex align-center gap-x-2">
              <VMenu activator="parent" :close-on-content-click="false">
                <VColorPicker v-model="miniChat.iconColor" />
              </VMenu>
              <div class="border rounded cursor-pointer"
                :style="{ backgroundColor: miniChat.iconColor, width: '36px', height: '36px' }" />
              <VTextField v-model="miniChat.iconColor" variant="outlined" density="compact" hide-details />
            </div>
            ...
            <VDivider class="my-4" />
            <p class="font-weight-medium mb-2">Botão de Copiar Cupom</p>
            <VLabel class="mb-1">Cor do fundo do botão</VLabel>
            <div class="d-flex align-center gap-x-2 mb-4">
              <VMenu activator="parent" :close-on-content-click="false">
                <VColorPicker v-model="miniChat.buttonBgColor" />
              </VMenu>
              <div class="border rounded cursor-pointer"
                :style="{ backgroundColor: miniChat.buttonBgColor, width: '36px', height: '36px' }" />
              <VTextField v-model="miniChat.buttonBgColor" variant="outlined" density="compact" hide-details />
            </div>
            <VLabel class="mb-1">Cor do texto do botão</VLabel>
            <div class="d-flex align-center gap-x-2">
              <VMenu activator="parent" :close-on-content-click="false">
                <VColorPicker v-model="miniChat.buttonTextColor" />
              </VMenu>
              <div class="border rounded cursor-pointer"
                :style="{ backgroundColor: miniChat.buttonTextColor, width: '36px', height: '36px' }" />
              <VTextField v-model="miniChat.buttonTextColor" variant="outlined" density="compact" hide-details />
            </div>
            ...
            <div v-if="miniChat.showOnConfirmation">
              <VLabel class="mt-4 mb-1">Título da mensagem de confirmação</VLabel>
              <VTextField v-model="miniChat.confirmationTitle" variant="outlined" density="compact"
                placeholder="Compra Aprovada!" />
              <VLabel class="mt-4 mb-1">Mensagem de confirmação</VLabel>
      ...
      <VWindowItem class="pa-4">
        ...
        <VSheet border rounded class="pa-4 mb-6">
          ...
          <div class="d-flex flex-column">
            <VSwitch v-model="paymentSettings.allowedMethods.card" label="Cartão de Crédito" color="success"
              :disabled="paymentSettings.allowedMethods.card && enabledMethodsCount === 1" />
            <VSwitch v-model="paymentSettings.allowedMethods.pix" label="PIX" color="success"
              :disabled="paymentSettings.allowedMethods.pix && enabledMethodsCount === 1" />
            <VSwitch v-model="paymentSettings.allowedMethods.boleto" label="Boleto" color="success"
              :disabled="paymentSettings.allowedMethods.boleto && enabledMethodsCount === 1" />
          </div>
        </VSheet>
        ...
        <VSheet border rounded class="pa-4 mb-6">
          ...
          <VSwitch v-model="paymentSettings.allowMultiPayments"
            :label="paymentSettings.allowMultiPayments ? 'Ativado' : 'Desativado'" color="success" />
          ...
          <VTextField v-if="paymentSettings.allowMultiPayments"
            ...
            label="Valor mínimo de pagamento no cartão" type="number" prefix="R$" variant="outlined" class="mt-4" />
        </VSheet>

        <VSheet border rounded class="pa-4">
          <p class="text-subtitle-1 mb-2">Segurança e Rastreamento</p>
          <VSwitch v-model="paymentSettings.captureIp"
            :label="paymentSettings.captureIp ? 'Captura de IP ativada' : 'Captura de IP desativada'" color="success" />
      ...
      <VWindowItem class="pa-4">
        ...
        <VSheet border rounded class="pa-4 mb-6">
          <p class="text-subtitle-1 mb-2">Meta Tags (SEO e Redes Sociais)</p>
          <p class="text-caption mt-1 mb-4">
            Essas informações ajudam nos resultados de busca (Google) e na forma como o link do seu checkout aparece
            quando compartilhado em redes sociais (Facebook, WhatsApp).
          </p>
          <VTextField v-model="scripts.metaTags.title" label="Título da Página" variant="outlined"
            placeholder="Ex: Oferta Especial - Produto Incrível" clearable class="mb-4" />
          <VTextarea v-model="scripts.metaTags.description" label="Descrição da Página" variant="outlined" rows="3"
            placeholder="Ex: Aproveite nossa oferta exclusiva por tempo limitado. Compre agora com desconto!" clearable
            class="mb-4" />
          <VTextField v-model="scripts.metaTags.keywords" label="Palavras-chaves (separadas por vírgula)"
            variant="outlined" placeholder="Ex: produto, oferta, exclusivo" clearable />
          <p class="text-caption mt-1">
            Insira as palavras-chave relevantes para o seu checkout, separando-as por vírgulas.
          </p>
        </VSheet>
        <VSheet border rounded class="pa-4 mb-6">
