...
<template>
  <div>
    ...
    <div v-if="!useMultiPayment">
      <v-btn-toggle v-model="singleMethod" mandatory class="mb-6">
    ...
    <VSheet v-if="paymentSettings.allowMultiPayments" border rounded class="pa-4 mb-6">
      <VSwitch v-model="useMultiPayment" label="Pagar com mais de uma forma" />
    </VSheet>
      ...
      <div v-if="useMultiPayment">
        ...
        <div class="d-flex ga-4 mb-4">
          <VCheckbox v-for="method in allAvailableMethods" :key="method.key" v-model="multiPaymentSelection"
            :label="method.title" :value="method.key" :rules="[rules.selectTwo]" />
        </div>

        <div v-if="multiPaymentSelection.length === 2">
