...
import { createHooks } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/node-mock-http@1.0.2/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/unstorage@1.16.1_@netlify+blobs@9.1.2_db0@0.3.2_ioredis@5.7.0/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/unstorage@1.16.1_@netlify+blobs@9.1.2_db0@0.3.2_ioredis@5.7.0/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/youch@4.1.0-beta.8/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
...
import { renderToString } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/vue@3.5.18_typescript@5.9.2/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/daniel/Imagens/teste-zendry/node_modules/.pnpm/unhead@2.0.14/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/daniel/Imagens/teste-zendry/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/daniel/Imagens/teste-zendry","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/daniel/Imagens/teste-zendry/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/daniel/Imagens/teste-zendry/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/daniel/Imagens/teste-zendry/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/daniel/Imagens/teste-zendry/.data/kv"}));
...
const _M7U8f0cw7EWgLMYOuYO2ZnSB9ITYCVPp8l70ulwYvk = (nitroApp) => {
...
const _npUEVa = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/daniel/Imagens/teste-zendry/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/daniel/Imagens/teste-zendry/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
